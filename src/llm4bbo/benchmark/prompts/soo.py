...
The trajectory is represented by 6 numerical parameters \
...
The trajectory is represented by 22 numerical parameters.
...
The trajectory is represented by 18 numerical parameters.
...
The trajectory is represented by 26 numerical parameters.
...
The trajectory is represented by 8 numerical parameters \
...
# Task and parameter semantics: CEC 2020 Section 2.1.6; Adjiman et al. Section 5.1.
...
that processes an olefin feed in the presence of an acid catalyst. \
Your objective is to maximize the score of the operating point \
which evaluates the overall performance of the alkylation process.

The operating point is represented by 7 continuous parameters \
and must satisfy 14 constraints, \
which encode the coupled operating relationships of the alkylation unit.
